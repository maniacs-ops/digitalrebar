...
for the p o s t roles operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the p o s t roles params
func (o *POSTRolesParams) WithTimeout(timeout time.Duration) *POSTRolesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the p o s t roles params
func (o *POSTRolesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the p o s t roles params
func (o *POSTRolesParams) WithContext(ctx context.Context) *POSTRolesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the p o s t roles params
func (o *POSTRolesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithBody adds the body to the p o s t roles params
func (o *POSTRolesParams) WithBody(body *models.RolesInput) *POSTRolesParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the p o s t roles params
func (o *POSTRolesParams) SetBody(body *models.RolesInput) {
	o.Body = body
}
