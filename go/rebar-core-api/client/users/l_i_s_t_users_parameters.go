...
for the l i s t users operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the l i s t users params
func (o *LISTUsersParams) WithTimeout(timeout time.Duration) *LISTUsersParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the l i s t users params
func (o *LISTUsersParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the l i s t users params
func (o *LISTUsersParams) WithContext(ctx context.Context) *LISTUsersParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the l i s t users params
