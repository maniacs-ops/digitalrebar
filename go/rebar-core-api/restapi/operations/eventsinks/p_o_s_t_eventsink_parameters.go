...
// POSTEventsinkParams contains all the bound params for the p o s t eventsink operation
// typically these are obtained from a http.Request
//
// swagger:parameters POST-eventsink
...
func (o *POSTEventsinkParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
