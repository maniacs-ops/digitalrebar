...
// DELETETenantParams contains all the bound params for the d e l e t e tenant operation
// typically these are obtained from a http.Request
//
// swagger:parameters DELETE-tenant
...
func (o *DELETETenantParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
