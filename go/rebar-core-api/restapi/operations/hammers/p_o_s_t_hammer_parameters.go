...
// POSTHammerParams contains all the bound params for the p o s t hammer operation
// typically these are obtained from a http.Request
//
// swagger:parameters POST-hammer
...
func (o *POSTHammerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
