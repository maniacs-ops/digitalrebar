...
// GETDeploymentsParams contains all the bound params for the g e t deployments operation
// typically these are obtained from a http.Request
//
// swagger:parameters GET-deployments
...
func (o *GETDeploymentsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
