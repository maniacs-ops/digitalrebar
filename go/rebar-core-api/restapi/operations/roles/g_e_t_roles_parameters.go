...
// GETRolesParams contains all the bound params for the g e t roles operation
...
func (o *GETRolesParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
