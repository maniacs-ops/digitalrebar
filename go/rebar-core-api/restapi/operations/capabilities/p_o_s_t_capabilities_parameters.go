...
// POSTCapabilitiesParams contains all the bound params for the p o s t capabilities operation
// typically these are obtained from a http.Request
//
// swagger:parameters POST-capabilities
...
func (o *POSTCapabilitiesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
